# nvim-treesitter-queries-menhir

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-menhir/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-menhir/actions/workflows/validate.yml)

Neovim tree-sitter queries for **menhir**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-menhir",
...
- [ ] Changes are scoped to `menhir` — do not include files for other languages
